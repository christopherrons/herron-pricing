...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("common.api", "com.herron.exchange:common-api:1.0.143")
            library("common", "com.herron.exchange:common:1.0.143")
            library("integration", "com.herron.exchange:integrations:1.0.1")
